...
class LocationForm extends React.Component {
    ...
    async handleSubmit(event) {
        ...
        if (response.ok) {
            ...
            const cleared = {
                ...
                roomCount: 'value={this.state.roomCount}',
                city: 'value={this.state.city}',
                state: 'value={this.state.state}',
        };
    ...
    handleNameChange(event) {
        const value = event.target.value; //input for location's name; if event occurred, target property on it is HTML tag
