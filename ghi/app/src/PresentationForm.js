          ...
          <div className="shadow p-4 mt-4">
            ...
            <form onSubmit={this.handleSubmit} id="create-presentation-form">
              ...
              <div className="mb-3">
                ...
                <textarea onChange={this.handleSynopsisChange} value={this.state.synopsis} placeholder="Enter synopsis..." required className="form-control" name="synopsis" id="synopsis" rows="5"></textarea>
              </div>
              <div className="mb-3">
                <select
                  onChange={this.handleConferenceChange} value={this.state.conference} required name="conference" id="conference" className="form-select">
